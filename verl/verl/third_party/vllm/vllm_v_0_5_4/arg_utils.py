...
class EngineArgs:
    ...
    served_model_name = None  # TODO: check this
    # tokenizer: Optional[str] = None # TODO: check this
    ...
    def create_engine_config(
        ...
        # NOTE: we only modify ModelConfig, other configs are import from vllm
        ...
        # NOTE: Use the world_size set by TORCHRUN
