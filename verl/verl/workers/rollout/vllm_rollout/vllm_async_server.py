...
class ExternalRayDistributedExecutor(Executor):
    ...
    def _init_executor(self) -> None:
        ...
        print(ray.util.list_named_actors())
        ...
        # print(f"instance_id: {self.vllm_config.instance_id} has {len(actor_names)} actors, vllm_dp_size: {vllm_dp_size} * vllm_tp_size: {vllm_tp_size} = {vllm_dp_size * vllm_tp_size} is expected.")
