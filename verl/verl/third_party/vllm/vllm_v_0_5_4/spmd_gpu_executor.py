...
class SPMDGPUExecutor(ExecutorBase):
    ...
    # TODO: verl not support speculative decode now
    ...
    def _init_workers_sp(self, model, distributed_init_method: str):
        ...
        # NOTE: torch.distributed.init_process_group will be called inside the init_model()
    ...
    def determine_num_available_blocks(self) -> Tuple[int, int]:
        ...
        # NOTE: Now we don't use a shared centralized controler but each process will
    ...
    # NOTE: This will not profile & capture the model(CUDAGraph) when rebuilding KVCache
    ...
    # NOTE add for verl to pass the abstract class test, not used
...
# TODO: not implemented async executor yet
