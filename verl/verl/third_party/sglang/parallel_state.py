...
# NOTE: this function is for megatron
...
# NOTE: After init SGLang rollout using class EngineFragment, user should always remember to call
...
# TODO: deviate from the v0.5.4, not pp now
# NOTE: the SGLang version using _TP instead of ps._TP
...
def initialize_model_parallel(
    ...
    # NOTE we don't assert world_size == tp * pp
...
# NOTE: In the vllm version parallel_state.py. verl created its own _TP and _PP as verl want to use
