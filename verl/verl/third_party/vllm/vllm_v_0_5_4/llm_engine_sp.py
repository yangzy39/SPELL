...
class LLMEngine(LLMEngine):
    ...
    def __init__(
        self,
        # NOTE: first two arguments are added for verl
        model: Union[nn.Module, Dict],  # model itself or its parameter dict
        tokenizer: nn.Module,
        # NOTE: vllm original arguments
        ...
        # TODO: maybe we can choose init here or from arguments
    ...
    # TODO: add for verl but we may not tokenizer in Rollout
    ...
    # NOTE: currently, we only support GPU executor
