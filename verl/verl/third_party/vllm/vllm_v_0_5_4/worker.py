...
# TODO: check why vllm has similar file in vllm.model_executor.parallel_utils.parallel_state
...
class Worker(Worker):
    ...
    def __init__(
        ...
        # TODO: set correct model runner class
        ...
        # NOTE: [VERL] For offloading inference engine params
        self.cpu_model = None
    ...
    def init_device(self) -> None:
        if self.device_config.device.type == "cuda":
            ...
            # NOTE: Modify for verl, Env vars will be set by TORCHRUN.
    ...
    def determine_num_available_blocks(self) -> Tuple[int, int]:
        ...
        # NOTE [VERL] use the remaining memory
        ...
        # NOTE: Add for [VERL], synchronize number of blocks with all the rank
    ...
    # NOTE: [VERL]: adapt from _execute_model_spmd()
...
def init_worker_distributed_environment(
    ...
    # NOTE use tcp://localhost:xxxx will hang in HF setting without megatron
